	...
	$(document).ready(function () {
		...
		$("#formentri").submit(function (e) {
			...
			$.ajax({
				type: 'post',
				dataType: 'json',
				url: "<?=site_url('Perbandingan/updateutama');?>",
				data: $(this).serialize(),
				error: function () {
	...
	function rk() {
	 ...
	 function showalternatif()
	 {
	 	$.ajax({
	 			type:'get',
	 			dataType:'html',
				url:"<?=site_url('Perbandingan/getaltcontainer');?>",
	 			data:"",
	 			error:function(){
...
?>
	...
	<div class="table-responsive">
		<table class="table table-bordered">
			<thead>
				<th colspan="<?=$jumlah+1;?>" class="text-center">Matrik Perbandingan Kriteria</th>
			</thead>
			<thead>
				<th>Kriteria</th>
	...
	?>
			...
			<tfoot>
				<tr>
					...
					{
					?>
					<td><input type="text" id="total<?=$h;?>" class="form-control" value="1" title="total<?=$h;?>" readonly="" /></td>
					<?php
					}
					?>
...
<div id="matrikdiv" class="col-md-12" style="display: none">
	...
	<div class="table-responsive">
		<table class="table table-bordered">
			<thead>
				<th colspan="<?=$jumlah+1;?>" class="text-center">Perkalian Matriks</th>
			</thead>
			<thead>
				<th>Kriteria</th>
				<?php
			...
			<tfoot>
				...
				<tr>
					<td colspan="4" align="center">
						...
						<input type='submit' name="nilai_rata1" value="simpan nilai" id="simpan_nilai" class="btn btn-primary">		
					</td>
				</tr>
			</tfoot>
		</table>
